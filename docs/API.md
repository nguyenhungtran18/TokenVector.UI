...
41 native-look widgets ()

selftest: `native_selftest`

Classes (32): `NativeButton`, `NativeLineEdit`, `NativeComboBox`, `NativeTreeCombo`, `NativeTableView`, `NativeTreeView`, `NativeTabBar`, `NativeMenuBar`, `NativeToolBar`, `NativeDialog`, `NativeScrollBar`, `NativeSplitter`, `NativeDockPanel`, `NativeMdiArea`, `NativeSysTray`, `NativeProgressBar`, `NativeSlider`, `NativeSpinBox`, `NativeListView`, `NativeToolTip`, `NativeCalendar`, `NativeColorPicker`, `NativeStatusBar`, `NativeWizard`, `NativeFontPicker`, `NativeRichEdit`, `NativeCheckBox`, `NativeRadioButton`, `NativeGroupBox`, `NativeRibbon`, `NativePropertyGrid`, `NativeContextMenu`

Functions (50): `make_native_button`, `make_native_button_default`, `make_native_check`, `make_native_lineedit`, `make_native_password`, `make_native_combo`, `make_native_treecombo`, `make_native_table`, `make_native_tree`, `make_native_tree_multi`, `make_native_tabs`, `make_native_tabs_closable`, `make_native_menubar`, `make_native_toolbar`, `make_native_dialog`, `make_native_dialog_buttons`, `make_native_scrollbar`, `make_native_splitter`, `make_native_dock`, `make_native_dock_float`, `make_native_mdi`, `make_native_systray`, `make_native_progress`, `make_native_slider`, `make_native_spinbox`, `make_native_listview`, `make_native_tooltip`, `make_native_calendar`, `make_native_colorpicker`, `make_native_statusbar`, `make_native_wizard`, `make_native_fontpicker`, `make_native_richedit`, `make_native_checkbox`, `make_native_tristate`, `make_native_radio`, `make_native_groupbox`, `make_native_groupcheck`, `make_native_ribbon`, `make_native_propgrid`, `make_native_contextmenu`, `nvcheck`, `nvcheck_i`, `nvcheck_f`, `nv_widths`, `nv_alloc_buf`, `nv_alloc_f64`, `nv_alloc_i32`, `nv_probe2`, `nv_render_probe`
## TkvUI.Widgets (`TkvUI.Widgets.tkv`)

UIElement + 42 widget (15 base + DPad/ControlBtn/Joystick + 10 Ant-inspired + 10 Wave A L1 Calendar/DateTime/ToolBox/Stacked/ScrollBar/Dial/CommandLink/KeySeq/LCD/TourTip), Spring/Tween, InvalidationManager, FrameScheduler, RenderLoop

selftest: `widget_selftest`

Classes: `SpringParams`, `SpringAnimation`, `Tween`, `InvalidationManager`, `FrameScheduler`, `UIElement`, `ButtonWidget`, `TextInputWidget`, `CardWidget`, `MetricRingWidget`, `ProgressBarWidget`, `SwitchWidget`, `SliderWidget`, `TextFieldWidget`, `ListViewWidget`, `TabsWidget`, `DialogWidget`, `ToastWidget`, `ChartSparklineWidget`, `BottomSheetWidget`, `NavBarWidget`, `SplitViewWidget`, `DirectionalPadWidget`, `ControlButtonWidget`, `VirtualJoystickWidget`, `AntTagWidget`, `AntBadgeWidget`, `AntAvatarWidget`, `AntAlertWidget`, `AntPaginationWidget`, `AntStepsWidget`, `AntTableWidget`, `AntSelectWidget`, `AntRateWidget`, `AntSpinWidget`, `CalendarWidget`, `DateTimeEditWidget`, `ToolBoxWidget`, `StackedWidget`, `ScrollBarWidget`, `DialWidget`, `CommandLinkWidget`, `KeySequenceEditWidget`, `LCDNumberWidget`, `TourTipWidget`, `RenderLoop`, `FocusManager`

Functions (64): `spring_new`, `ease_linear`, `ease_out_cubic`, `ease_in_out_cubic`, `ease_out_back`, `ease_apply`, `tween_to`, `make_invalidation`, `make_frame_scheduler`, `make_button`, `make_button_outline`, `make_textinput`, `make_card`, `make_card_notch`, `make_metric_ring`, `make_progress`, `make_switch`, `make_slider`, `make_textfield`, `empty_textfield`, `make_listview`, `make_tabs`, `make_dialog`, `make_toast`, `make_sparkline`, `make_bottom_sheet`, `make_navbar`, `make_split_view`, `make_dpad`, `make_control_btn`, `make_joystick`, `ant_str_count`, `ant_tag_color`, `make_ant_tag`, `make_ant_badge`, `make_ant_dot`, `make_ant_avatar`, `ant_alert_color`, `make_ant_alert`, `make_ant_pagination`, `make_ant_steps`, `make_ant_table`, `make_ant_select`, `make_ant_rate`, `make_ant_spin`, `make_calendar`, `make_datetime_edit`, `make_toolbox`, `make_stacked`, `make_scrollbar`, `make_dial`, `make_command_link`, `make_key_sequence`, `make_lcd`, `make_tour_tip`, `make_render_loop`, `render_loop_pump_all`, `widget_row_labels`, `widget_sample_values`, `widget_count_non_bg`, `widget_count_changed`, `widget_check`, `widget_check_i`, `widget_check_ge`
